...
</div><div><span class="badge ${t.risk_level.toLowerCase()}">${t.risk_score} ${t.risk_level}</span><div class="small">${t.decision}</div></div></div>`).join('')||'<div class="small">Waiting for stream…</div>'}
